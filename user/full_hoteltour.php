...
<?php include "./partials/navbar.php" ?>
    ...
    <div class="px-10 py-24">
        <h1 class="text-5xl font-semibold mb-10 text-center">Hotel + Tour Package</h1>
            ...
            <div class="carousel flex flex-wrap transition-transform duration-300 md:gap-2 lg:gap-6 mx-auto">
                ...
                <div class="carousel-item flex-none w-full md:w-[50%] lg:w-[23.5%]">
                    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div class="p-5">
                            <a href="./detail_hoteltour.php">
                                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Myanmar 5D + Hotel Swadikap</h5>
                            </a>
                            <p class="mb-3 text-sm font-normal text-gray-700 dark:text-gray-400 line-through mb-[-5px]">Myr.2.115.000</p>
                            <p class="mb-3 text-lg text-[#1f3b6f] dark:text-gray-400 font-bold">Myr.2.115.000</p>
