            ...
            <div class="carousel flex transition-transform duration-300 md:gap-2 lg:gap-6 mx-auto">
                ...
                <div class="carousel-item flex-none w-full md:w-[50%] lg:w-[23.5%]">
                    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                            <img class="rounded-t-lg" src="<?= base_url('hotel/'.$h->image)?>" alt="" />
                        </a>
                        <div class="p-5">
                            <a href="#">
                            ...
                            <a href="<?= site_url('main/roomall/'.$h->id_hotel)?>" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Read more
